...
// threshold (mm). Tune once sensor mounting + the maze's actual cell
// size are known - this should land at roughly half a cell width.
#define SOLVER_WALL_THRESHOLD_MM 100
...
#define SOLVER_CELL_TICKS        0    // encoder ticks per cell; 0 = use timed movement above - TODO once encoders are wired and calibrated
